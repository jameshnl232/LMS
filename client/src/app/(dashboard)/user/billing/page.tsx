      ...
      <div className="billing__container">
        ...
        <div className="billing__grid">
          {isLoadingTransactions ? (
            ...
            <Table className="billing__table text-gray-900">
              <TableHeader className="billing__table-header">
                <TableRow className="billing__table-header-row ">
                  <TableHead className="billing__table-cell text-gray-900 ">Date</TableHead>
                  <TableHead className="billing__table-cell text-gray-900">Amount</TableHead>
                  <TableHead className="billing__table-cell text-gray-900">
                    Payment Method
                  </TableHead>
                </TableRow>
              </TableHeader>
